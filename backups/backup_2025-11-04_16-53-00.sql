...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_BI_VALIDAR_BACKUP` BEFORE INSERT ON `tbl_ms_backups`
FOR EACH ROW BEGIN
    DECLARE V_COUNT INT;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_AI_BITACORA_BACKUP` AFTER INSERT ON `tbl_ms_backups`
FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRG_BU_ACTUALIZAR_ESTADO_BACKUP` BEFORE UPDATE ON `tbl_ms_backups`
FOR EACH ROW BEGIN
...
-- Dump completed on 2025-11-04 16:53:00
